outpath='/nfs/dust/cms/user/vdlinden/legacyTTH/ratefactors_legacy/ntuple_2016' # path of output of analyzer
scriptpath='ratefactors_2016' # folder containing shell scripts that will have to be run on cluster

outpath='/nfs/dust/cms/user/swieland/ttH_legacy/ntuple_2Btags/2016_newGT' # path of output of analyzer
scriptpath='legacy_2016_hdamp' # folder containing shell scripts that will have to be run on cluster
samplelist='ttH_legacy_samples_hdamp_2016.csv' # samples list

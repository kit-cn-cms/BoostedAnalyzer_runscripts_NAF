...
scriptpath='legacy_2017_v2_missingSamples' # folder containing shell scripts that will have to be run on cluster
samplelist='ttH_legacy_samples_2017_missingSamples.csv' # samples list

outpath='/nfs/dust/cms/user/vdlinden/legacyTTH/ntupling/2016_vjets' # path of output of analyzer
scriptpath='legacy_2016_lo_vjets_jec' # folder containing shell scripts that will have to be run on cluster
samplelist='ttH_legacy_lo_vjets_2016.csv' # samples list

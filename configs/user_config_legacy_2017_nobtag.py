outpath='/nfs/dust/cms/user/vdlinden/legacyTTH/ntupling/2016_nobtags' # path of output of analyzer
scriptpath='legacy_2017_nobtag' # folder containing shell scripts that will have to be run on cluster
samplelist='ttH_legacy_nobtag_2017.csv' # samples list

outpath='/nfs/dust/cms/user/vdlinden/legacyTTH/ntupling/2018_vjets' # path of output of analyzer
scriptpath='legacy_2018_lo_vjets_jec' # folder containing shell scripts that will have to be run on cluster
samplelist='ttH_legacy_lo_vjets_2018.csv' # samples list
...
systematicVariations='systematicVariations_new_2018.txt'

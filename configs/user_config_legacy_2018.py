outpath='/nfs/dust/cms/user/vdlinden/legacyTTZ/ntuples/2018' # path of output of analyzer
scriptpath='ntuples_2018' # folder containing shell scripts that will have to be run on cluster
samplelist='ttZ_legacy_samples_2018.csv' # samples list

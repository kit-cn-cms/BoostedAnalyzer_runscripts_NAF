outpath='/nfs/dust/cms/user/swieland/ttH_legacy/ntuple_JECgroups/2018' # path of output of analyzer
scriptpath='legacy_2018' # folder containing shell scripts that will have to be run on cluster
samplelist='ttH_legacy_samples_2018_Sebastian.csv' # samples list

outpath='/nfs/dust/cms/user/swieland/ttH_legacy/ntuple_2Btags/2017' # path of output of analyzer
scriptpath='legacy_2017_hdamp' # folder containing shell scripts that will have to be run on cluster
samplelist='ttH_legacy_samples_hdamp_2017.csv' # samples list

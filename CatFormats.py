...
sampleNames=[ ["tth","$\\rm t\\bar{t}H$"],["ttH","$\\rm t\\bar{t}H$"],["TTH","$\\rm t\\bar{t}H$"],["tthbb","$\\rm t\\bar{t}Hb\\bar{b}$"],["ttHbb","$\\rm t\\bar{t}Hb\\bar{b}$"], ["ttbar","t\\bar{t}"], ["ttbar_l","$\\rm t\\bar{t}+lf$"] , ["ttbar_bb","$\\rm t\\bar{t}+b\\bar{b}$"], ["ttbar_b","$\\rm t\\bar{t}+b$"], ["ttbar_cc","$\\rm t\\bar{t}+c\\bar{c}$"], ["ttW","$\\rm t\\bar{t}+W$"], ["ttZ","$\\rm t\\bar{t}+Z$"], ["SingleT","Single t"], ["WJets","W+jets"], ["ZJets","Z+jets"], ["DiBoson","Diboson"],["data","Data"]]

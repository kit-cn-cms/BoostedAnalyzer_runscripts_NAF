outpath='/nfs/dust/cms/user/mwassmer/ntuples/minor_backgrounds/' # path of output of analyzer
scriptpath='minor_backgrounds' # folder containing shell scripts that will have to be run on cluster
samplelist='minor_backgrounds_used.csv' # samples list

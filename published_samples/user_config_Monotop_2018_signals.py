...
scriptpath='MonoTop_2018_signals' # folder containing shell scripts that will have to be run on cluster
samplelist='../auto_samples_datasets_monotop_official_signals_2018.csv' # samples list

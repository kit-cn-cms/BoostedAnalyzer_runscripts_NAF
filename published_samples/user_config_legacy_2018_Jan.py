outpath='/nfs/dust/cms/user/vdlinden/legacyTTH/ntuples/legacy_2018_ttZ_v4/' # path of output of analyzer
scriptpath='legacy_2018_ttZ_splitJES' # folder containing shell scripts that will have to be run on cluster
samplelist='../ttZ_samples_2018.csv' # samples list
...
systematicVariations='splitJES.txt'

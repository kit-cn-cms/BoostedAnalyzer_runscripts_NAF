outpath='/nfs/dust/cms/user/vdlinden/legacyTTH/ntuples/2018_ttZ/' # path of output of analyzer
scriptpath='legacy_2018_ttZ' # folder containing shell scripts that will have to be run on cluster
samplelist='../ttH_legacy_samples_2018_ttZ_Jan.csv' # samples list
...
dbs="prod/phys3" # dbs instance: boosted miniaod is in prod/phys03, standard miniaod in prod/global

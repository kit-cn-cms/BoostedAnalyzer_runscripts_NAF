outpath='/nfs/dust/cms/user/kelmorab/ttZ/ntuples' # path of output of analyzer
scriptpath='ttZAnalysis_data' # folder containing shell scripts that will have to be run on cluster
samplelist='../samples_ttZAnalysis_data.csv' # samples list
...
systematicVariations='systematics_data.txt'

...
for f in files:
    call(['qsub', '-cwd', '-S', '/bin/bash','-l', 'h=bird*', '-hard','-l', 'os=sld6', '-l' ,'h_vmem=3000M', '-l', 's_vmem=3000M' ,'-o', 'logs/$JOB_NAME.o$JOB_ID', '-e', 'logs/$JOB_NAME.e$JOB_ID','-v','X509_USER_PROXY=/nfs/dust/cms/user/mwassmer/proxy/x509up_u26621','-q','short.q', f])

...
scriptpath='runScripts_Spring17-v2_minorBKGs' # folder containing shell scripts that will have to be run on cluster
samplelist='minorSamples.csv' # samples list

...
def writeSubmitCode(script, isArray, nTasks):
    ...
    submitCode += "environment = X509_USER_PROXY=/nfs/dust/cms/user/mhorzela/proxy/x509up_u31867\n"
    submitCode += "use_x509userproxy = True\n"
    submitCode += "x509userproxy = /nfs/dust/cms/user/mhorzela/proxy/x509up_u31867\n"
